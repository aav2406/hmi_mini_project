            ...
            <div class="card" style="margin-top:20px">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row">
                                        <label for="elec_sub" class="col-md-4 col-form-label text-md-right">Elective Subjects</label>
                                        <div class="col-md-6">
                                            @foreach($findsub as $f)
                                              @foreach($f->subjects as $f1)
                                                @foreach($elec as $ele) 
                                                    @if($ele->id == $f1->id) 
                                                        <input style="margin-bottom:15px" id="phone_no" disabled type="text" class="form-control" name="phone_no" value="{{$f1->subject}}" required>
                                                    @endif
                                                @endforeach
                                              @endforeach
                                            @endforeach
